...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  useEffect(() => {
    if (!firestore) return;
    getSystemSettings(firestore).then((loadedSettings) => {
       setSettings(loadedSettings);
       if (loadedSettings.sounds) {
           audioManager.init(loadedSettings.sounds);
       }
    });
  }, [firestore]);
  ...
  }, [firebaseApp, firestore, auth, storage, userAuthState, settings, messaging, isMessagingSupported]);
